...
$file = 'C:\jra\analysis\zenso-jra-verify\jra_csv\target_turf.csv'
$sql = @"
SELECT CONVERT(varchar,k.開催日,23) AS 開催日, k.開催場所, k.レース番号, ri.距離, ri.周回方向, k.馬番, k.馬名, k.着順,
...
WHERE k.開催日 BETWEEN '2023-01-01' AND '2025-12-31' AND ri.コース種別=N'芝'
"@
